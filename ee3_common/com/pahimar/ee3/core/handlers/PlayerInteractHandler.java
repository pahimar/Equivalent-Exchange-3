...
public class PlayerInteractHandler {
	...
	public void playerInteract(PlayerInteractEvent event) {
		if (event.action == PlayerInteractEvent.Action.RIGHT_CLICK_BLOCK && event.entityPlayer.getHeldItem().itemID < Block.blocksList.length && Block.blocksList[event.entityPlayer.getHeldItem().itemID] != null) {
