...
public final class Messages {
    ...
    public static final String OWNER_SET_TO_SELF = "misc.ee:owner_set_to_self";
    public static final String ENERGY_VALUE = "misc.ee:energy_value";
    ...
    public static final class Gui {
        ...
        private static final String GUI_PREFIX = "container.ee:";
    ...
    public static final class Tooltips {
        ...
        private static final String TOOLTIP_PREFIX = "tooltip.ee:";
