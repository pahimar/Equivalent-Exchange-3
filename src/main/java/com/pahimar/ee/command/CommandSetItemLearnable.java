...
import com.pahimar.ee.network.message.MessageSetBlacklistEntry;
...
public class CommandSetItemLearnable extends CommandBase {
    ...
    public void execute(MinecraftServer minecraftServer, ICommandSender commandSender, String[] args) throws CommandException {
        ...
        if (args.length < 2) {
            ...
            Network.INSTANCE.sendToAll(new MessageSetBlacklistEntry(itemStack, BlacklistRegistryProxy.Blacklist.KNOWLEDGE, false));
            notifyCommandListener(commandSender, this, Messages.Commands.SET_ITEM_LEARNABLE_SUCCESS, commandSender.getName(), itemStack.getTextComponent());
        }
    }
