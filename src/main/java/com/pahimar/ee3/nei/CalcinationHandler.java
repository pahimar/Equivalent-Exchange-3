...
public class CalcinationHandler extends TemplateRecipeHandler
{
	...
	public void loadTransferRects() {
		transferRects.add(new RecipeTransferRect(new Rectangle(39, 20, 18, 18),
				"fuel"));
		transferRects.add(new RecipeTransferRect(new Rectangle(69, 19, 24, 16),
				getRecipeID()));
	}
	...
	public void loadUsageRecipes(ItemStack ingredient) {
		...
		for (ItemStack stack : ItemAlchemicalDust.getAlchemicalDusts()) {
			if (NEIServerUtils.areStacksSameTypeCrafting(stack,
					CalcinationHelper.getCalcinationResult(ingredient)))
