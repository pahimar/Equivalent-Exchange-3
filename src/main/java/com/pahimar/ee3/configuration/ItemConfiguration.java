...
public class ItemConfiguration
{
    ...
    protected static void init(File configFile)
    {
        ...
        try
        {
            ...
            ItemIds.ALCHEMICAL_COAL = itemConfiguration.getItem(Strings.ALCHEMICAL_COAL_NAME, ItemIds.ALCHEMICAL_COAL_DEFAULT).getInt(ItemIds.ALCHEMICAL_COAL_DEFAULT);
            ItemIds.MOBIUS_FUEL = itemConfiguration.getItem(Strings.MOBIUS_FUEL_NAME, ItemIds.MOBIUS_FUEL_DEFAULT).getInt(ItemIds.MOBIUS_FUEL_DEFAULT);
            ItemIds.AETERNALIS_FUEL = itemConfiguration.getItem(Strings.AETERNALIS_FUEL_NAME, ItemIds.AETERNALIS_FUEL_DEFAULT).getInt(ItemIds.AETERNALIS_FUEL_DEFAULT);
